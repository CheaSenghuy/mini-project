...
export CORE_PEER_ROOTDIR=${PWD}/ledger1

# peer channel create --help
peer channel create -o localhost:7050 -c $CHANNEL_NAME -f ./channel-artifacts/mychannel.tx --outputBlock ./channel-artifacts/mychannel.block --tls --cafile $ORDERER_CA
